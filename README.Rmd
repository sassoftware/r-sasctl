...
The sasctl package for R is available from SAS as a tar.gz file. You can download releases from [https://github.com/sassoftware/r-sasctl/releases](https://github.com/sassoftware/r-sasctl/releases).

After you download the package source, you can install the package with a command that is similar to the following:
